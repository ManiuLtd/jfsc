...
use App\Http\Controllers\WxPayApiController;
use App\Http\Controllers\WxPayConfigController;

class WxPayJsApiPayController
{
    /**
     *
    ...
    public function GetJsApiParameters($UnifiedOrderResult)
    {
        ...
        $jsapi = new WxPayJsApiPayController();
