            ...
            <div class="list-body">
                <div class="container">
                    ...
                    {{--<div class="list">
                        ...
                        <div class="right">{{ $value['purchased_at'] }}</div>
                        --}}{{--<div class="right">{{ date('Y-m-d',$value['purchased_at']) }}</div>--}}{{--
                    </div>
                    <div class="list">
                        <div class="left">保固有效期</div>
                        <div class="right">{{ $value['warranty_ended_at'] }}</div>
                        --}}{{--<div class="right">{{ date('Y-m-d',$value['warranty_ended_at']) }}</div>--}}{{--
                    </div>--}}
                </div>
            </div>
        @else
